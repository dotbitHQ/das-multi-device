...
const (
	...
	ActionUpdate_device_key_list TxAction = 30
	...
	DasActionCrossRefund     = "cross_refund"
)
...
func FormatTxAction(action string) TxAction {
	...
	case common.DasActionUpdateKeyList:
		return ActionUpdate_device_key_list
	}
...
func FormatActionType(actionType TxAction) string {
	...
	case ActionUpdate_device_key_list:
		return common.DasActionUpdateKeyList
	}
	return ""
}
