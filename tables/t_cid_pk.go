...
type TableCidPk struct {
	...
	KeylistOutpoint string            `json:"keylist_outpoint" gorm:"column:keylist_outpoint;type:varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL"`
